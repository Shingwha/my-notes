...
以下图片使用相对路径引用，位于 `assets/demo-image.svg`和`assets/主页面.png`：

![内部示例图片](./assets/demo-image.svg)

![主页面示例图片](./assets/主页面.png)
...
### Placehold.co 占位图
![Placehold.co 图片](https://placehold.co/800x450/764ba2/white?text=Centered+Image)
